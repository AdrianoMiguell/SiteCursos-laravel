...
<button type="button" class="btnGeral btnGeral-dark" data-bs-toggle="modal"
    data-bs-target="#modalSlide{{ $key_conteudo }}">
    <i class="bi bi-pencil-fill"></i>
</button>

<!-- Modal -->
<div class="modal fade modal-conteudo" id="modalSlide{{ $key_conteudo }}" tabindex="-1"
    aria-labelledby="modalSlide{{ $key_conteudo }}Label" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('slide.edit') }}" method="POST">
                    @csrf
                    @method('PUT')

                    <h1 class="modal-title mt-3 mb-4" id="modalSlide{{ $key_conteudo }}Label">Editar Slide</h1>
                    ...
                    <input type="hidden" name="slide_id" value="{{ $conteudo->slide->id }}">
                    ...
                    <div class="my-3">
                        ...
                        <input type="text" name="title" value="{{ $conteudo->slide->title }}" id="conteudo_title"
                            class="form-control">
                    </div>
                    ...
                    <div class="my-3">
                        ...
                        <textarea type="text" name="text" id="conteudo_text" class="form-control">{{ $conteudo->slide->text }}</textarea>
                    </div>
                    ...
                    <div class="my-3">
                        ...
                        <textarea type="text" name="link" id="conteudo_link" class="form-control">{{ $conteudo->slide->link }}</textarea>
                    </div>
                    ...
                    <div class="my-3">
                        ...
                        <input type="number" class="form-control" name="order" id="conteudo_order"
                            value="{{ $conteudo->order }}">
                    </div>
