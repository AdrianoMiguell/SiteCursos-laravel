...
<button type="button" class="btnGeral btnGeral-dark" data-bs-toggle="modal"
    data-bs-target="#modalVideo{{ $key_conteudo }}">
    <i class="bi bi-pencil-fill"></i>
</button>

<!-- Modal -->
<div class="modal fade modal-conteudo" id="modalVideo{{ $key_conteudo }}" tabindex="-1"
    aria-labelledby="modalVideo{{ $key_conteudo }}Label" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('video.edit') }}" method="POST">
                    ...
                    <h1 class="modal-title mt-3 mb-4" id="modalVideo{{ $key_conteudo }}Label">Editar Video</h1>
                    ...
                    <input type="hidden" name="video_id" value="{{ $conteudo->video->id }}">
                    ...
                    <div class="my-3">
                        ...
                        <input type="text" name="title" value="{{ $conteudo->video->title }}" id="conteudo_title"
                            class="form-control">
                    </div>
                    ...
                    <div class="my-3">
                        ...
                        <textarea type="text" name="text" id="conteudo_text" class="form-control">{{ $conteudo->video->text }}</textarea>
                    </div>
                    ...
                    <div class="my-3">
                        ...
                        <textarea type="text" name="link" id="conteudo_link" class="form-control">{{ $conteudo->video->link }}</textarea>
                    </div>
